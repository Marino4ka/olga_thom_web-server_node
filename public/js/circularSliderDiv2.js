...
function createSliderOnLoad () {
    for (var i = 0; i < slidersLength; i++) {
       ...
       currentSlides[i].classList.add("sliderImg", "sliderImg__size2");
...
next.onclick = function next () {
       ...
       currentSlides[slidersLength].classList.add("sliderImg", "sliderImg__size2");     
...
prev.onclick = function prev () {
       ...
       currentSlides[0].classList.add("sliderImg", "sliderImg__size2");
